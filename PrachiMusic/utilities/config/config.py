...
OWNER_ID = list(map(int, getenv("OWNER_ID", "6688753848").split()))
HEROKU_API_KEY = getenv("HEROKU_API_KEY", None)
HEROKU_APP_NAME = getenv("HEROKU_APP_NAME", None)
UPSTREAM_REPO = getenv("UPSTREAM_REPO", "https://github.com/Ranavanshi/PrachiXMusic")
UPSTREAM_BRANCH = getenv("UPSTREAM_BRANCH", "divy")
GIT_TOKEN = getenv("GIT_TOKEN", None)
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/prachi_music_updates")
SUPPORT_GROUP = getenv("SUPPORT_GROUP", "https://t.me/noob_savvy_chats")
...
if PING_IMG_URL:
    if PING_IMG_URL != "PrachiMusic/resource/Ping.jpeg":
        if not re.match("(?:http|https)://", PING_IMG_URL):
            PING_IMG_URL = "https://te.legra.ph/file/6abc32c3858f205434cd5.jpg"

if START_IMG_URL:
    if START_IMG_URL != "PrachiMusic/resource/Ping.jpeg":
